...
import com.example.yangle.controller.ex.*;
import com.example.yangle.entity.User;
import com.example.yangle.service.IUserService;
...
public class UserController extends BaseController {
  ...
  public JsonResult<User> login(String username, String password, HttpSession session) {
   logger.info("登陆debug：用户名："+username);
