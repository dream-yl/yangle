...
import com.example.yangle.entity.Cart;
import com.example.yangle.entity.CartVO;
import com.example.yangle.mapper.CartMapper;
...
public class CartServiceImpl implements ICartService {
   ...
   * @return 受影响的行数
   */
  private void updateNum(Integer cid, Integer num, String username, Date modifiedTime) throws UpdateException {
